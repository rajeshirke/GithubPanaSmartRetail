...
namespace Retail.Views.MyVisits.TaskSummary
{
    public partial class QRCode : ContentPage
    {
        ...
        public QRCode(TaskQuestionAnswerToSubmitResponse _TaskQuestionAnswer1)
        {
            InitializeComponent();

            TaskQuestionAnswer1 = _TaskQuestionAnswer1;
            BindingContext = QRCodeViewModel = new QRCodeViewModel(Navigation, TaskQuestionAnswer1);
        }
        ...
        void TapGestureRecognizer_Tapped(System.Object sender, System.EventArgs e)
        {
            try
            {
                ...
                MessagingCenter.Send<TaskQuestionAnswerToSubmitResponse>(QRCodeViewModel.TaskQuestionAnswer, "AnsweredQrcode");
