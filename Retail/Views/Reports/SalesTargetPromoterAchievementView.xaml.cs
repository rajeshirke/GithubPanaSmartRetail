...
{
    public partial class SalesTargetPromoterAchievementView : ContentPage
    {
        public SalesTargetPromoterAchievementViewModel viewModel { get; set; }
        ...
        public SalesTargetPromoterAchievementView()
        {
            InitializeComponent();
            BindingContext = viewModel = new SalesTargetPromoterAchievementViewModel(Navigation);
        ...
        async void Button_Clicked(System.Object sender, System.EventArgs e)
        {
            ...
            reportCreateUpdateRequest.LocationIds = SelectedStores;
            reportCreateUpdateRequest.Dates = Convert.ToDateTime(DateTime.Now.Date.ToShortDateString());
            reportCreateUpdateRequest.SinglePersonId = null;

            if (reportCreateUpdateRequest != null)
            {
                await viewModel.GetSalesTargetPromoterAchievementReport(reportCreateUpdateRequest);
            }
        }
    }
}
