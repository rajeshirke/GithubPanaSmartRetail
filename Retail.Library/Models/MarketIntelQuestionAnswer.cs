...
{
    public partial class MarketIntelQuestionAnswer
    {
        ...
        public virtual MarketIntelCollection MarketIntelCollection { get; set; }
        ...
        public virtual ICollection<MarketIntelAnswerUploadedFile> MarketIntelAnswerUploadedFiles { get; set; }
    }
}
