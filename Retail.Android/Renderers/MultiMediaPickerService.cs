...
namespace Retail.Droid.Renderers
{
    public class MultiMediaPickerService : IMultiMediaPickerService
    {
        ...
        event EventHandler<MediaFile> IMultiMediaPickerService.OnMediaPicked
        {
            add
            {
        ...
        event EventHandler<IList<MediaFile>> IMultiMediaPickerService.OnMediaPickedCompleted
        {
            add
            {
                throw new NotImplementedException();
        ...
        Task<IList<MediaFile>> IMultiMediaPickerService.PickPhotosAsync()
        {
            throw new NotImplementedException();
        }

        Task<IList<MediaFile>> IMultiMediaPickerService.PickVideosAsync()
        {
            throw new NotImplementedException();
        }
    }
